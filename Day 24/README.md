# Day 24: Docker Volumes Explained | Foundation for Kubernetes Persistent Storage | CKA Certification
...
We’ve already discussed this `Dockerfile` in **Day-3’s notes**. You can revisit the notes for a recap:
- **GitHub link**: [Day-3 Resources](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2003)
...
- **GitHub Repository**: [Day 05: Multi-Stage Docker Builds](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2005)  
