# Day 31: TLS in Kubernetes MASTERCLASS | PART 1 | Mutual Auth (SSH), TLS 1.3, Types of CAs | CKA Certification
...
* When **Aadi** downloads something from his **S3 bucket**, **Aadi** is the **client**, and the **S3 bucket** is the **server**.
