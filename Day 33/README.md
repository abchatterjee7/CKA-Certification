# Day 33: TLS in Kubernetes MASTERCLASS | PART 3 | Private CAs, TLS Auth Flow, mTLS in Kubernetes Cluster | CKA Certification
...
1. **Day 7**: Kubernetes Architecture
   ...
   * **GitHub**: [Day 7 Repo](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2007)
...
3. **Day 31**: TLS in Kubernetes MASTERCLASS | PART 1 | Mutual Auth (SSH), TLS 1.3, Types of CAs
   ...
   * **GitHub**: [Day 31 Repo](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2031)
...
4. **Day 32**: TLS in Kubernetes MASTERCLASS | PART 2 | mTLS, kubeconfig & Kubernetes Context
   ...
   * **GitHub**: [Day 32 Repo](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2032)
...
We know from [Day 15](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2015) that etcd runs as a **static pod**. So, inspect the etcd manifest:
