# Day 37: MASTER Kubernetes Service Accounts & Authentication | CKA Certification
...
* It is a **CSV file** that contains entries like:
  ...
  ```
  mypass,aadi,uid123,"devs,admins"
  ```
...
* You can use these credentials with tools like `curl`:
  ...
  ```bash
  curl -u aadi:mypass https://<cluster-endpoint>/api
  ```
...
* Format (CSV):
  ...
  ```
  abcd1234token,aadi,uid123,"devs"
  ```
...
**Day 36 Notes:** [GitHub Repository](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2036)  
