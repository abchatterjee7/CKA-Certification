# Day 39: Custom Resources (CR) and Custom Resource Definitions (CRD) Explained with Demo | CKA Certification

### Prerequisites:

To fully understand this concept, it’s highly recommended to revisit the **Kubernetes API section from Day 35**:

* [Day 35 GitHub Notes](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2035)
...
metadata:
  name: backuppolicies.ops.abchatterjee7  # Must be <plural>.<group>; uniquely identifies the CRD cluster-wide

spec:
  group: ops.abchatterjee7             # Defines the API group used in the resource's apiVersion (e.g., ops.abchatterjee7/v1)

  names:
    plural: backuppolicies                # Plural form used in CLI and API endpoints (e.g., /apis/ops.abchatterjee7/v1/backuppolicies)
...
```bash
kubectl get crd backuppolicies.ops.abchatterjee7
```
...
```
backuppolicies   bp   ops.abchatterjee7/v1   true   BackupPolicy
```
...
```yaml
apiVersion: ops.abchatterjee7/v1   # Must match the group and version defined in the CRD
