# Day 40: Kubernetes Operators Deep Dive with Hands-On Demo | CKA Certification
## Table of Contents
...
* [Day 39 GitHub Notes](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2039)
...
```
backuppolicies.ops.abchatterjee7
```

And a CR:

```yaml
apiVersion: ops.abchatterjee7/v1
kind: BackupPolicy
metadata:
  name: mysql-backup
  namespace: default
