# Day 45: Pull Private Images in Kubernetes with imagePullSecrets & ServiceAccount | CKA Certification
...
```text
docker.io/aadiraj48dockerhub/my-python-image
```

You can then use tags to specify versions:

```text
docker.io/aadiraj48dockerhub/my-python-image:v1
docker.io/aadiraj48dockerhub/my-python-image:v2
```
...
| Namespace  | `aadiraj48dockerhub` | Usually your DockerHub username or org name         |
...
```yaml
image: docker.io/aadiraj48dockerhub/my-python-image:v1
```
...
```
Failed to pull image "docker.io/aadiraj48dockerhub/my-python-image:v1":
...
* **GitHub Notes**: [CKA Course - Day 37](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2037)
...
```bash
docker build -t aadiraj48dockerhub/app1:1.0.0 .
```
...
```bash
docker push aadiraj48dockerhub/app1:1.0.0
```

> Replace `aadiraj48dockerhub` with your own Docker Hub username if you’re following this demo with your own account.
...
kubectl create secret docker-registry dockerhub-secret \
  ...
  --docker-username=aadiraj48dockerhub \
  --docker-password=YOUR_PASSWORD \
  --docker-email=abchatterjee7@gmail.com
```
...
spec:
  containers:
  - name: python-cont
    image: docker.io/aadiraj48dockerhub/app1:1.0.0
  imagePullSecrets:
...
```json
{
  "auths": {
    "https://index.docker.io/v1/": {
      "username": "aadiraj48dockerhub",
      "password": "password11",
      "email": "abchatterjee7@gmail.com",
      "auth": "Y2x..."
    }
  }
}
