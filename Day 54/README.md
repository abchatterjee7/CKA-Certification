# Day 54: Build a Multi-Node Kubernetes Cluster with kubeadm + Calico Operator | CKA Certification
...
* [Day 7 Notes](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2007)

**Day 25 — Core & Extensions: CNI, CSI, CRI, Add-Ons & Plugins**
* [Day 25 Notes](https://github.com/abchatterjee7/CKA-Certification/tree/main/Day%2025)
...
> **Why this change?** In the Day 54 notes we didn’t open **TCP 5473**. With operator-based Calico, the **Typha** component is commonly enabled and (by default) runs with **hostNetwork**, so each `calico-node` (Felix) connects to Typha on **5473/TCP**. Without this, `calico-node` can sit in **Running (0/1)** with Typha connection timeouts.
